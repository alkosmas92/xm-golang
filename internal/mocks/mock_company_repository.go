...
func (m *MockCompanyRepository) GetCompanyByCompanyID(ctx context.Context, companyID uuid.UUID) (*models.Company, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCompanyRepositoryMockRecorder) GetCompanyByCompanyID(ctx, companyID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCompanyByCompanyID", reflect.TypeOf((*MockCompanyRepository)(nil).GetCompanyByCompanyID), ctx, companyID)
}
